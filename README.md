...
4. **Experience the Demo**:
   - 📊 **Dashboard**: Open [http://localhost:3000](http://localhost:3000) to see the Vault TVL and Approval Gate.
   - 🤖 **TrueForge UI**: Open [http://localhost:8790](http://localhost:8790) to watch the agent in action. Import the provided `agent.json` and start the session.
   - ⚔️ **The Attack**: The attacker container will automatically start draining funds. Watch the agent detect it, run the sandbox proof, and request your approval on the dashboard!
